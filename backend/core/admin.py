...
class WaitlistEntryAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        "email", "x_username_display",
        "telegram_username_display", "status_display", "region", "niche", "created_at",
    ]
    list_filter = ["status", "region", "niche", "created_at"]
    search_fields = ["email", "x_username", "telegram_username"]
    ordering = ["-created_at"]
    readonly_fields = [
        "id", "telegram_id", "telegram_username",
        "telegram_display_name", "other_platforms",
    ...
    fieldsets = (
        ...
        ("X/Twitter", {"fields": ("x_username", "x_link")}),
        ("Profile", {"fields": ("region", "niche", "other_platforms")}),
